...
public class MyQuartzTask implements Runnable{
	...
	private static final Logger logger = Logger.getLogger(MyQuartzTask.class);
	 ...
	 private static int POOL_NUM = 200;     //线程池数量
	...
	public void run() {
		      ...
		      System.out.println(timeNow+" 【定时任务-cron任务触发器-异步方法】"+"--通过线程池方式创建的线程：" + Thread.currentThread().getName() + " ");  
	          long startTime = System.currentTimeMillis();
			  //第一步： 配置cookie
			  String cookie ="isolate-web-session-id=39681c33-ecc0-4049-ba7a-8e2d461d7cbb";
