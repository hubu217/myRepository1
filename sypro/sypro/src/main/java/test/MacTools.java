...
public class MacTools {
    ...
    public static List<Object> getMacList() throws Exception {
        java.util.Enumeration<NetworkInterface> en = NetworkInterface.getNetworkInterfaces();
        StringBuilder sb = new StringBuilder();
        List<Object> tmpMacList=new ArrayList<Object>();
        ...
        List<Object> unique = tmpMacList.stream().distinct().collect(Collectors.toList());
        return unique;
    }
    public static void main(String[] args) throws Exception {
        System.out.println("进行 multi net address 测试===》");
        List<Object> macs=getMacList();
